...
def desenho_quadrado():
    ...
    while not glfw.window_should_close(window):
        ...
        if (giro == 0) :
            ...
            #faz a translação em 0.5 para x (primeira posição), y (segunda posição) e nada em z (terceira posição)
            giro = 1
            #giro recebe 1 para que ele não se repita uma segunda vez
    glfw.terminate()
    #termina o glfw
